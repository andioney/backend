	...
	<div class="container">
		<div class="panel panel-danger">
			<div class="panel-heading">   
				...
				<button type='button' class="btn btn-danger" data-toggle="modal" data-target="#nuevoProducto"><span class="glyphicon glyphicon-plus" ></span> Nuevo Producto</button>
			</div>
                <h4><i class='panel-heading'></i> Productos </h4>
		 </div>
